    ...
    ui(new Ui::shop)
{
    ...
    ui->lineEdit_chicken_mat->setReadOnly(true);
    ...
    ui->lineEdit_sheep_milk_sale->setReadOnly(true);
    ...
    ui->lineEdit_chicken_egg_sale->setReadOnly(true);
    ui->lineEdit_chicken_mat_sale->setReadOnly(true);
    ui->lineEdit_cow_mat_sale->setReadOnly(true);
    ui->lineEdit_cow_milk_sale->setReadOnly(true);
    ui->lineEdit_sheep_mat_sale->setReadOnly(true);
